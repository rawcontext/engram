...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: CSS injection from trusted config
...
type ChartTooltipContentProps = Partial<RechartsTooltipContentProps<ValueType, NameType>> &
	React.ComponentProps<"div"> & {
		hideLabel?: boolean;
