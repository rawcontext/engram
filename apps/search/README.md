...
```bash
curl http://localhost:6176/v1/search/ready
```
...
**Standard Search**
```bash
curl -X POST http://localhost:6176/v1/search/query \
...
```bash
curl -X POST http://localhost:6176/v1/search/multi-query \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST http://localhost:6176/v1/search/session-aware \
  -H "Content-Type: application/json" \
  -d '{
...
```bash
curl -X POST http://localhost:6176/v1/search/embed \
  -H "Content-Type: application/json" \
  -d '{
