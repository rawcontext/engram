...
async def test_embed_similar_texts_high_similarity(client: AsyncClient) -> None:
    ...
    response1 = await client.post("/v1/search/embed", json={"text": "machine learning algorithms"})
    response2 = await client.post("/v1/search/embed", json={"text": "machine learning models"})
