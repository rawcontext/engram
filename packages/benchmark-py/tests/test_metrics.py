...
class TestLatencyMetrics:
	...
	def test_basic_percentiles(self) -> None:
		...
		assert metrics.p90_ms == 910  # 90th percentile
		assert metrics.p95_ms == 955  # 95th percentile
		assert metrics.p99_ms == 991  # 99th percentile
